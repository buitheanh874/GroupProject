...
class WebsterControllerConfig:
    ...
    min_cycle_sec: int = 60                 # Fixed 60s for fair comparison with RL
    max_cycle_sec: int = 60                 # Fixed 60s for fair comparison with RL
    default_cycle_sec: int = 60             # Fixed 60s for fair comparison with RL
