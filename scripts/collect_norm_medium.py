"""Collect normalization stats for Medium demand (500 veh/hr/lane)."""
...
def main():
    ...
    all_states = []
    num_episodes = 10  # Reduced for faster collection
    ...
    output = {
        ...
        "demand_level": "medium_500",
    }
    
    output_path = project_root / "configs/norm_medium.json"
