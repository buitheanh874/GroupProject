"""Collect normalization stats for Hard demand (650 veh/hr/lane)."""
...
def main():
    ...
    output = {
        ...
        "demand_level": "hard_650",
    }
    
    output_path = project_root / "configs/norm_hard.json"
